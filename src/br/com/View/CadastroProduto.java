...
import br.com.Model.ProdutoTableModel;
...
public class CadastroProduto extends javax.swing.JInternalFrame {
    ...
    private ModelProduto produto = null;
    private ControllerProduto produtoDAO = new ControllerProduto();
    ...
    private void initComponents() {
        ...
        btNovo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/Imagens/buscar.png"))); // NOI18N
        btNovo.setText("Novo");
        btNovo.setFocusable(false);
        btNovo.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        btNovo.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btNovo.setMargin(new java.awt.Insets(2, 8, 2, 8));
        btNovo.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/Imagens/buscar-foco.png"))); // NOI18N
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(21, 2, 0, 35);
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        if (validarFormulario()) {
            ...
            produto.setPrecoCompra((Double) Double.parseDouble(ftfPrecoCompra.getText()));
            produto.setPrecoVenda((Double) Double.parseDouble(ftfPrecoVenda.getText()));
...
//                    return;
    ...
    private boolean validarFormulario() {
        ...
        if (((Double)Double.parseDouble(ftfPrecoCompra.getText())) <= 0) {
        ...
        if (((Double) Double.parseDouble(ftfPrecoVenda.getText())) <= 0) {
            //System.out.println(ftfPrecoVenda.getText());
            JOptionPane.showMessageDialog(this, "Preço de venda inválido.", "Alerta", JOptionPane.WARNING_MESSAGE);
            ftfPrecoVenda.requestFocus();
            return false;
        }
        if (((Double) Double.parseDouble(ftfPrecoVenda.getText())) <= ((Double) Double.parseDouble(ftfPrecoCompra.getText()))) {
            System.out.println("Venda: "+ftfPrecoVenda.getValue()+"Compra: "+ftfPrecoCompra.getValue());
