...
import br.com.Controller.ControllerCompra;
import br.com.Model.CompraTableModel;
import br.com.Model.ItemCompraTableModel;
...
public class LancamentoCompra extends javax.swing.JInternalFrame {
    ...
    private ModelCompra compra = null;
    private ControllerCompra compraDAO = new ControllerCompra();
    ...
    private void initComponents() {
        ...
        btFornecedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/Imagens/buscar.png"))); // NOI18N
        ...
        btFornecedor.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/Imagens/buscar-foco.png"))); // NOI18N
    ...
    public void setFornecedor(ModelFornecedor cliente) {
    ...
    private void salvar(boolean finalizar) {
        if (validarFormulario()) {
            compra.setFornecedor((ModelFornecedor) ftfFornecedor.getValue());
